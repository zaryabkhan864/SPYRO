...
const Banner = () => {
    return (
        <div
            className="flex justify-center items-center min-h-[145vh] bg-cover bg-no-repeat relative "
            style={{
            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    <div className="text-white">
                        <h1 className="font-orbitron font-bold text-64px " >
                            <span className='leading-snug text-transparent' style={{ WebkitTextStroke: "2px #FF4300" }}>Unleash</span> your <br /> inner Athlete
                        </h1>
                        <p className="mt-4 font-Outfit font-medium text-18px">
